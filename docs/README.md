...
- [Приложение для iOS (Capacitor, разработка отложена)](#приложение-для-ios-capacitor-разработка-отложена)
...
## Приложение для iOS (Capacitor, разработка отложена)

Та же Capacitor-оболочка, что и Android, собирается в CI (симулятор), но публикация и брендинг не доведены — не активное направление сейчас.

- [Приложение для iOS: статус и что нужно для возобновления работы](IOS.md).
