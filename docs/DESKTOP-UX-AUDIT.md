<a id="desktop-ux-audit"></a>

> **Контекст документа.** Исторический аудит интерфейса, выполненный для этапа 20.39.1. Инвентаризация и оценки покрытия отражают тот срез; последующие изменения нужно сверять с исходниками.

# Аудит удобства настольного интерфейса

[Документация](README.md) · [Обзор проекта](../README.md)

Снимок на 20.39.1, перед 20.40 (Design Системные маршруты + Home). Задача — понять,
...
- [Роутинг](#роутинг)
- [Доступность разделов: основа информационной архитектуры](#доступность-разделов-основа-информационной-архитектуры)
- [Полная инвентаризация страниц](#полная-инвентаризация-страниц)
- [Покрытие стилями настольного интерфейса на момент аудита](#покрытие-стилями-настольного-интерфейса-на-момент-аудита)
- [Существующие таблицы и сетки](#существующие-таблицы-и-сетки)
- [Токены дизайн-системы (для справки, полный список в DESKTOP-DESIGN.md)](#токены-дизайн-системы-для-справки-полный-список-в-desktop-designmd)
- [Открытый пункт (флаг, не блокер)](#открытый-пункт-флаг-не-блокер)
...
<a id="реальность-доступа-ключевой-вывод-для-ia"></a>

## Доступность разделов: основа информационной архитектуры
...
<a id="текущее-покрытие-desktop-css"></a>

## Покрытие стилями настольного интерфейса на момент аудита
...
<a id="существующие-tablegrid-паттерны"></a>

## Существующие таблицы и сетки
