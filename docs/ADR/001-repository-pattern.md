...
| Статус-кво + код-ревью | ❌ отклонено | Ровно та дисциплина, что уже приводила к пропущенным org-scope проверкам (см. [CHANGELOG.md](../../CHANGELOG.md), аудит контроля доступа 19.11.0) |
