...
const CLEAN_FILES = [
  ...
  'src/core/plans/application/read-model.ts',
  'src/core/plans/application/employee-plan-draft.ts',
  'src/core/plans/application/errors.ts',
  'src/core/plans/ports/read-model.ts',
  'src/core/plans/index.ts',
  'src/core/schedules/application/generate-draft.ts',
  'src/core/schedules/application/apply-draft.ts',
  'src/core/schedules/application/errors.ts',
  'src/core/schedules/ports/read.ts',
