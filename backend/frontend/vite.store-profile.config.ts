...
/**
 * 21.x (Frontend rewrite continuation) — sixth per-page build config,
...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: false,
    lib: {
      entry: resolve(__dirname, 'src/pages/store-profile/index.ts'),
      formats: ['iife'],
      name: '__t2StoreProfilePageBundle',
      fileName: () => 'pages/store-profile.bundle.js'
    }
  }
});
