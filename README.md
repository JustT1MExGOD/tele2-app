...
[![version](https://img.shields.io/badge/version-20.39.0-2AABEE?style=flat-square)](#21-история-версий)
...
**Актуальная версия клиента:** `20.39.0` · **Часовой пояс истины:** `Europe/Moscow`
...
- **20.39 Desktop Shell** ✅ — развёрнутая критика 20.38 от владельца
  ...
  следующими шагами того же roadmap (см. §21, 20.39.0)
...
*README · актуально на v20.39.0 · август 2026*
