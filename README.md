...
[![version](https://img.shields.io/badge/version-20.40.2-2AABEE?style=flat-square)](#21-история-версий)
...
**Актуальная версия клиента:** `20.40.2` · **Часовой пояс истины:** `Europe/Moscow`
...
- **20.40 Design System + Home Dashboard** ✅ — владелец продукта прислал
  ...
  через auto-fit, не фиктивное место) (см. §21, 20.40.0-20.40.2)
...
*README · актуально на v20.40.2 · август 2026*
