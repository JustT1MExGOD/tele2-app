...
[![version](https://img.shields.io/badge/version-20.14.0-2AABEE?style=flat-square)](#21-история-версий)
...
**Актуальная версия клиента:** `20.14.0` · **Часовой пояс истины:** `Europe/Moscow`
...
- **20.14 Жесты по apple-design skill** ✅ — установленный в сессии skill
  ...
  20.14.0)
- **20.15-20.17 Concurrency & Reliability** — idempotency-ключи на
...
*README · актуально на v20.14.0 · август 2026*
