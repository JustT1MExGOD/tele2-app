...
### После 19.2 — UX-батчи и security-аудит ✅ частично (19.3.0-19.15.0)
...
security/архитектурного ревью (20 пунктов) закрыт двумя заходами: rate
...
уязвимостей (19.14.0); затем единый Fastify error handler с маппингом
ошибок Postgres, аудит зависимостей как gate в CI, контекстные логи
(19.15.0). Оставшиеся пункты того же ревью — schema-валидация (TypeBox/Zod)
на всех write-роутах, слой доступа к данным, frontend TypeScript+Vite,
tenant-check как Fastify-декораторы, полный audit trail, кэш
supervisor-scope и т.п. — крупнее по объёму и ждут отдельного
...
*README · актуально на v19.15.0 · август 2026*
