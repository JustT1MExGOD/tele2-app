...
![version](https://img.shields.io/badge/version-19.18.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `19.18.0`  
...
### После 19.2 — UX-батчи и security-аудит ✅ частично (19.3.0-19.18.0)
...
write-роутах — продажи, касса, график, смены (19.18.0, в процессе).
...
- TypeBox-схемы (`@sinclair/typebox`, 19.18.0) на `schema.body` роута —
  ...
  денежных/расписательных write-роутов (§21, 19.18.0); динамические по
  форме тела (кастомные метрики продаж, разнородные `sync/batch`-операции)
...
*README · актуально на v19.18.0 · август 2026*
