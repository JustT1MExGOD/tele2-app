...
![version](https://img.shields.io/badge/version-19.17.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `19.17.0`  
...
### После 19.2 — UX-батчи и security-аудит ✅ частично (19.3.0-19.17.0)
...
security/архитектурного ревью (20 пунктов) закрыт тремя заходами: rate
...
(19.17.0). Оставшиеся пункты того же ревью — schema-валидация (TypeBox/Zod)
на всех write-роутах, слой доступа к данным, frontend TypeScript+Vite,
полный audit trail, кэш supervisor-scope и т.п. — крупнее по объёму и ждут
отдельного приоритетного захода, не сделаны одним махом умышленно.
...
*README · актуально на v19.17.0 · август 2026*
