...
[![version](https://img.shields.io/badge/version-20.37.0-2AABEE?style=flat-square)](#21-история-версий)
...
**Актуальная версия клиента:** `20.37.0` · **Часовой пояс истины:** `Europe/Moscow`
...
*README · актуально на v20.37.0 · август 2026*
