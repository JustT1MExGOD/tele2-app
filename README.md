...
![version](https://img.shields.io/badge/version-15.4.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `15.4.0`  
...
| 🗺️ дальше | Подсказки «кого куда поставить» на основе прогноза |
