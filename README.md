...
[![version](https://img.shields.io/badge/version-20.57.3--rc-2AABEE?style=flat-square)](#21-история-версий)
...
**Актуальная выпущенная версия:** `20.56.0` · **Release candidate на review:** `20.57.3` (внутренний чат 20.57.0 + hotfix pass 20.57.1 + 20.57.2 + visual/UX pass 20.57.3 — набор точечных фиксов и security-патчей, см. §21, ещё не задеплоено) · **Часовой пояс истины:** `Europe/Moscow`
...
*README · актуально на v20.56.0 (выпущено) · v20.57.3 в статусе release candidate · сентябрь 2026*
