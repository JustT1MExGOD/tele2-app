...
![version](https://img.shields.io/badge/version-19.19.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `19.19.0`  
...
### После 19.2 — UX-батчи и security-аудит ✅ частично (19.3.0-19.19.0)
...
Оставшиеся пункты того же ревью — TypeBox на ~25 оставшихся write-роутах
(задачи, поддержка, промокоды, объявления, отчёты, метрики, план-факт),
слой доступа к данным, frontend TypeScript+Vite, полный audit trail, кэш
...
- TypeBox-схемы (`@sinclair/typebox`, 19.18.0) на `schema.body` роута —
  ...
  CRUD сотрудников/точек (19.19.0). Динамические по форме тела (кастомные
  метрики продаж, разнородные `sync/batch`-операции) сознательно оставлены
...
*README · актуально на v19.19.0 · август 2026*
