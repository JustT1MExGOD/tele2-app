...
![version](https://img.shields.io/badge/version-15.11.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `15.11.0`  
...
| ✅ готово (15.8.0-15.11.0) | Эпик 17.0 — мультитенант: секторы/сети точек, чат-роутинг по точке, супервайзер на сектор, «Команда»/график/касса/промокоды изолированы по сети, переключатель сети у admin. Проверено на реальной второй сети (`test_network`) |
