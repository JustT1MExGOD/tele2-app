...
![version](https://img.shields.io/badge/version-19.14.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `19.14.0`  
...
### После 19.2 — UX-батчи и security-аудит ✅ частично (19.3.0-19.14.0)
...
security/архитектурного ревью (20 пунктов) частично закрыт «быстрыми
победами» — rate limiting, security headers, прод-гварды на insecure-auth/
BOT_TOKEN, короче срок жизни сессии, magic-bytes на аватарке, зависимости
без известных уязвимостей (19.14.0). Оставшиеся пункты того же ревью —
schema-валидация (TypeBox/Zod) на всех write-роутах, слой доступа к данным,
frontend TypeScript+Vite, централизованный error handler, полный audit
trail, кэш supervisor-scope и т.п. — крупнее по объёму и ждут отдельного
...
*README · актуально на v19.14.0 · август 2026*
