...
![version](https://img.shields.io/badge/version-15.9.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `15.9.0`  
...
| 🏗️ эпик 17.0, фаза A готова (15.8.0) | Мультитенант: секторы/сети точек, чат-роутинг по точке, супервайзер на сектор — готово. Фаза B: изоляция данных на уровне экранов (сотрудники/график/промокоды/касса видны только своей сети) — ждёт реальной второй сети для проверки на живых данных |
