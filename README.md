...
![version](https://img.shields.io/badge/version-15.10.0-2AABEE?style=flat-square)
...
**Актуальная версия клиента:** `15.10.0`  
...
| 🏗️ эпик 17.0, фаза A + сотрудники готовы (15.8.0-15.10.0) | Мультитенант: секторы/сети точек, чат-роутинг по точке, супервайзер на сектор, изоляция «Команды» по сети + переключатель сети у admin — готово и проверено на реальной второй сети. Осталось по фазе B: график/промокоды/касса видны только своей сети |
