...
[![version](https://img.shields.io/badge/version-20.57.2--rc-2AABEE?style=flat-square)](#21-история-версий)
...
![tests](https://img.shields.io/badge/tests-1531%20passing-2EA043?style=flat-square&logo=vitest&logoColor=white)
...
**Актуальная выпущенная версия:** `20.56.0` · **Release candidate на review:** `20.57.2` (внутренний чат 20.57.0 + hotfix pass 20.57.1 + 20.57.2 — набор точечных фиксов и security-патчей, см. §21, ещё не задеплоено) · **Часовой пояс истины:** `Europe/Moscow`
...
*README · актуально на v20.56.0 (выпущено) · v20.57.2 в статусе release candidate · сентябрь 2026*
